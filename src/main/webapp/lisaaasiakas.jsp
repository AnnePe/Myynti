...
$(document).ready(function(){      //jqueryn aloitustagi
	...
	$("#etunimi").focus(); //viedään kursori etunimi-kenttään kun sivu ladataan
});
...
function lisaaTiedot(){	
	...
	$.ajax({url:"asiakkaat", data:formJsonStr, type:"POST", dataType:"json", success:function(result) {  //Restissä POST tarkoittaa lisää    
